        ...
        <div class="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6">
            ...
            <section class="grid gap-6 lg:grid-cols-3">
                ...
                <div
                    ...
                    @if ($focusAreaAdvice)
                        <div class="mt-4 rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-3 text-xs text-indigo-900 dark:border-indigo-500/30 dark:bg-indigo-500/10 dark:text-indigo-100">
